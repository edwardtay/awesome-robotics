...
| [Foxglove SDK](https://github.com/foxglove/foxglove-sdk) | 291 | SDK for publishing multimodal robotics data to Foxglove visualizations. |
| [micro-ROS](https://github.com/micro-ROS/micro_ros_setup) | 506 | ROS 2 on microcontrollers (ESP32, STM32). |
| [ros2_control](https://github.com/ros-controls/ros2_control) | 973 | Hardware abstraction and real-time control. |
...
| [SAPIEN](https://github.com/haosulab/SAPIEN) | 810 | Python | Manipulation sim for articulated objects. |
...
| [Tesseract](https://github.com/tesseract-robotics/tesseract) | 384 | C++ | Motion-planning environment for industrial robotics. |
...
| [Lanelet2](https://github.com/fzi-forschungszentrum-informatik/Lanelet2) | 955 | C++ | HD map framework for autonomous driving. |
...
| Tool | Stars | Language | Description |
|------|-------|----------|-------------|
| [GraspNet](https://github.com/graspnet/graspnet-baseline) | 998 | Python | 6-DoF grasp detection on point clouds. |
| [AnyGrasp](https://github.com/graspnet/anygrasp_sdk) | 963 | Python | Grasp detection for any object in dense clutter. |
| [Contact-GraspNet](https://github.com/NVlabs/contact_graspnet) | 518 | Python | NVIDIA 6-DoF grasps conditioned on contact regions. |
...
| [Aerostack2](https://github.com/aerostack2/aerostack2) | 368 | C++ | ROS 2 framework for autonomous aerial robots. |
...
| [Orocos KDL](https://github.com/orocos/orocos_kinematics_dynamics) | 895 | C++ | Kinematics and dynamics library for ROS. |
...
| [VoxPoser](https://github.com/huangwl18/VoxPoser) | 829 | Python | Composable 3D value maps from LLMs for manipulation. |
...
| [ROS 2 DDS](https://github.com/ros2/rmw_fastrtps) | 202 | C++ | ROS 2 middleware using Fast-RTPS. |
...
| Tool | Stars | Language | Description |
|------|-------|----------|-------------|
| [CARLA ScenarioRunner](https://github.com/carla-simulator/scenario_runner) | 675 | Python | Autonomous driving test scenarios. |
| [ROS 2 Launch Testing](https://github.com/ros2/launch) | 157 | Python | Integration testing for ROS 2 systems. |
| [rosbag2](https://github.com/ros2/rosbag2) | 431 | C++ | Record and replay ROS 2 topic data. |
...
| [KDL](https://github.com/orocos/orocos_kinematics_dynamics) | 895 | C++ | Orocos kinematics and dynamics for ROS. |
...
| [RViz2](https://github.com/ros2/rviz) | 476 | C++ | 3D visualization for ROS 2. |
...
| [GELLO](https://github.com/wuphilipp/gello_software) | 517 | Python | Low-cost teleoperation with 3D-printed replicas. |
...
| [Crazyswarm2](https://github.com/IMRCLab/crazyswarm2) | 246 | Python | ROS 2 framework for Crazyflie nano-drone swarms. |

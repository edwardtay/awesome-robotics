...
| [Foxglove SDK](https://github.com/foxglove/foxglove-sdk) | 266 | SDK for publishing multimodal robotics data to Foxglove visualizations. |
| [micro-ROS](https://github.com/micro-ROS/micro_ros_setup) | 496 | ROS 2 on microcontrollers (ESP32, STM32). |
| [ros2_control](https://github.com/ros-controls/ros2_control) | 927 | Hardware abstraction and real-time control. |
...
| [SAPIEN](https://github.com/haosulab/SAPIEN) | 788 | Python | Manipulation sim for articulated objects. |
...
| [Tesseract](https://github.com/tesseract-robotics/tesseract) | 371 | C++ | Motion-planning environment for industrial robotics. |
...
| [Lanelet2](https://github.com/fzi-forschungszentrum-informatik/Lanelet2) | 952 | C++ | HD map framework for autonomous driving. |
...
| Tool | Stars | Language | Description |
|------|-------|----------|-------------|
| [GraspNet](https://github.com/graspnet/graspnet-baseline) | 971 | Python | 6-DoF grasp detection on point clouds. |
| [AnyGrasp](https://github.com/graspnet/anygrasp_sdk) | 905 | Python | Grasp detection for any object in dense clutter. |
| [Contact-GraspNet](https://github.com/NVlabs/contact_graspnet) | 507 | Python | NVIDIA 6-DoF grasps conditioned on contact regions. |
...
| [Aerostack2](https://github.com/aerostack2/aerostack2) | 360 | C++ | ROS 2 framework for autonomous aerial robots. |
...
| [VoxPoser](https://github.com/huangwl18/VoxPoser) | 816 | Python | Composable 3D value maps from LLMs for manipulation. |
...
| [Isaac GR00T](https://github.com/NVIDIA/Isaac-GR00T) | 7k | Python | NVIDIA open humanoid foundation model (GR00T N). |
...
| Tool | Stars | Language | Description |
|------|-------|----------|-------------|
| [CARLA ScenarioRunner](https://github.com/carla-simulator/scenario_runner) | 667 | Python | Autonomous driving test scenarios. |
...
| [IKFast](https://github.com/rdiankov/openrave) | 808 | C++ | Analytical inverse kinematics solver distributed with OpenRAVE. |
...
| [RViz2](https://github.com/ros2/rviz) | 467 | C++ | 3D visualization for ROS 2. |
...
| [GELLO](https://github.com/wuphilipp/gello_software) | 494 | Python | Low-cost teleoperation with 3D-printed replicas. |
...
| Tool | Stars | Language | Description |
|------|-------|----------|-------------|
| [Open-RMF](https://github.com/open-rmf/rmf) | 415 | C++ | Robot Fleet Management for multi-robot coordination. |
| [Crazyswarm2](https://github.com/IMRCLab/crazyswarm2) | 240 | Python | ROS 2 framework for Crazyflie nano-drone swarms. |
